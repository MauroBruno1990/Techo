  ...
  return (
    <div className="container-fluid reality-center">
      <div className="row">
          ...
          <div className="card img-reality">
            ...
            <div className="card-body">
              ...
              <p className="card-text">Sin acceso formal al servicio de energía</p>
            </div>
          </div>
