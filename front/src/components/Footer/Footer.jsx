        ...
        <div className="containerDiv">
          <div className="column1">
            ...
            <div className="items">
              ...
              <a
                href="https://twitter.com/TECHOarg?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"
                target="blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-twitter iconItem"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://www.linkedin.com/company/techo---argentina/"
                target="blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-linkedin iconItem"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://www.instagram.com/techo_argentina/"
                target="blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-instagram iconItem"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://www.youtube.com/channel/UC16rwTsi85Yw5yeEFOTPkyA"
                target="blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-youtube iconItem"
                  viewBox="0 0 16 16"
                >
              ...
              <a
                href="https://api.whatsapp.com/message/DKITG55I5PLBO1"
                target="blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-whatsapp iconItem"
                  viewBox="0 0 16 16"
                >
